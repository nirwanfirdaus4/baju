...
<form action="<?php echo base_url('admin/Produk/tambahdataProduk') ?>" id="form_traditional_validation" name="form_traditional_validation" role="form" autocomplete="off" method="post" class="validate" enctype="multipart/form-data">
...
<select class="form-control" name="ukuran" required="required">
	<?php
	$query_ukuran=$this->db->query("SELECT * FROM tb_ukuran");
			foreach ($query_ukuran->result() as $keyUkuran) { ?>
				<option value="<?php echo $keyUkuran->id_ukuran ?>"><?php echo $keyUkuran->nama_ukuran ?></option>
            <?php }
	 ?>
</select>
