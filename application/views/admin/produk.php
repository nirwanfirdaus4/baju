...
<li><a href="#" class="active">Daftar Produk</a> </li>
</ul>
...
<h4>Data <span class="semi-bold">Produk</span></h4>
<div class="tools">
<!-- <a href="javascript:;" class="collapse"></a>
<a href="#grid-config" data-toggle="modal" class="config"></a>
<a href="javascript:;" class="reload"></a>
<a href="javascript:;" class="remove"></a> -->
<a href="<?php echo base_url('admin/Produk/tambahdataProduk') ?>"><button type="button" class="btn btn-success btn-cons">Tambah Data</button></a>
</div>
</div>
<div class="grid-body ">
...
<!--         <td><button data-toggle="modal" data-target="#myModal<?php echo $no; ?>" type="button" class="btn btn-primary"><i class="fa fa-eye"></i></button>    </td> -->
        <td>
            ...
            <a href="<?php echo base_url('admin/Produk/hapus_produk/'.$key['id_produk']) ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>         
        </td>
</tr>
