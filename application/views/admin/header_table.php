...
<!-- Mirrored from webarch.revox.io/3.0/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Oct 2019 04:08:44 GMT -->
<head>
	...
	<script src="<?php echo base_url('assets/head/8jwJmQl7fEk_9sdV6OByoscERU8.js') ?>"></script>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/plugins/jquery-datatable/css/jquery.dataTables.css') ?>" />
