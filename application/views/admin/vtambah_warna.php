...
<li><a href="#" class="active">Tambah Warna</a> </li>
</ul>
...
<form action="<?php echo base_url('admin/Produk/tambahdataWarna') ?>" id="form_traditional_validation" name="form_traditional_validation" role="form" autocomplete="off" method="post" class="validate">

<div class="form-group">
<label class="form-label">Nama Warna</label>
<div class="input-with-icon right">
<i class=""></i>
<input class="form-control" id="form1CardHolderName" name="nama_warna" type="text" required>
</div>
</div>

<div class="form-group">
<label class="form-label">Kode Warna</label><span class="help">contoh : #95a5a6</span>
<div class="input-with-icon right">
<i class=""></i>
<input class="form-control" id="form1CardHolderName" name="kode_warna"  type="text" required>
</div>
</div>
