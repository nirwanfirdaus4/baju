...
<li><a href="#" class="active">Edit Warna</a> </li>
</ul>
...
<form action="<?php echo base_url('admin/Produk/editWarna/'.$data[0]['id_warna']) ?>" id="form_traditional_validation" name="form_traditional_validation" role="form" autocomplete="off" method="post" class="validate">

<div class="form-group">
<label class="form-label">Nama Warna</label>
<div class="input-with-icon right">
<i class=""></i>
<input class="form-control" value="<?php echo $data[0]['nama_warna'] ?>" id="form1CardHolderName" name="nama_warna" type="text" required>
</div>
</div>
...
<div class="input-with-icon right">
<i class=""></i>
<input class="form-control" value="<?php echo $data[0]['kode_warna'] ?>" id="form1CardHolderName" name="kode_warna" type="text" required>
</div>
</div>
