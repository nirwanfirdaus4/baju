							...
							<tbody>
								<tr>
									<td class="product-col">
										<img src="<?php echo base_url('assets_front/img/cart/1.jpg'); ?>" alt="">
										<div class="pc-title">
								...
								<tr>
									<td class="product-col">
										<img src="<?php echo base_url('assets_front/img/cart/2.jpg'); ?>" alt="">
										<div class="pc-title">
								...
								<tr>
									<td class="product-col">
										<img src="<?php echo base_url('assets_front/img/cart/3.jpg'); ?>" alt="">
										<div class="pc-title">
											<h4>Skinny Jeans</h4>
											<p>$45.90</p>
										</div>
